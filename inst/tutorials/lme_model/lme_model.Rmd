...
![Figure 1: A simple scatter plot. Notice how the data looks grouped](images/ex.PNG)

![Figure 2: If we attach a adjust a line to each person, we get a better idea of what trends exist](images/ex1.PNG)

## The Model

Our model can be expressed as $Y_{i} = X_{i}'\beta + Z_{i}b_i + \epsilon_{ij}$ where
...
$b_i$ is vector of the random-effects regression coefficients

$\epsilon_{ij}$ - a vector of errors
